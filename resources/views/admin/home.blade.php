                                    ...
                                    <div class="portlet-body" id="chats">
                                        <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                            <ul class="chats">
                                                ...
                                                <li class="in">
                                                    <img class="avatar" alt="" src="{{url('/')}}/assets/layouts/layout/img/avatar1.jpg" />
                                                    <div class="message">
                                                        <span class="arrow"> </span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mt-widget-2">
                                                    <div class="mt-head" style="background-image: url({{url('/')}}assets/pages/img/background/32.jpg);">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mt-widget-2">
                                                    ...
                                                    <div class="mt-head" style="background-image: url({{url('/')}}assets/pages/img/background/43.jpg);">
                                                        <div class="mt-head-label">
